...
assert WebUI.verifyElementVisible(findTestObject('Object Repository/Checkout/Success Checkout/h2_Thank you for your order')) == true : 'should not done checkout due to empty cart'
